...
MediaDetail,QYDH,RWDL,TSSC,HZZX, TopicArticleList, AreaArticleList,SMYL
...
urlpatterns = [
    ...
    url(r'^pinzhuodongtai/$',PZDT.as_view(),name="pinzhuodongtai"),
    url(r'^pinzhuowenhua/$',PZWH.as_view(),name="pinzhuowenhua"),
    url(r'^pinzhuopinpai/$',PZPP.as_view(),name="pinzhuopinpai"),
    url(r'^pinzhuopinjian/$',PZPJ.as_view(),name="pinzhuopinjian"),
    url(r'^shuimodanqing/$',ShuiMoDanQing.as_view(),name="shuimodanqing"),
    url(r'^mingrentang/$',MRT.as_view(),name="mingrentang"),
    url(r'^shuimoyixun/$',SMYX.as_view(),name="shuimoyixun"),
    ...
    url(r'^huizhanzixun/$',HZZX.as_view(),name="huizhanzixun"),
    url(r'^topic_article_list/$',TopicArticleList.as_view(),name="topic_article_list"),
    url(r'^area_article_list/$',AreaArticleList.as_view(),name="area_article_list"),
    url(r'^shuimoyilang/$',SMYL.as_view(),name="shuimoyilang"),
]